<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./index.php">Hi Admin</a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Chardie Gotis <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="../classes/logout.php"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                        </li>
